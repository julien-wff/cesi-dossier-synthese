...
func ParsePdf(f *io.ReadSeeker) (PdfParseResponse, *utils.ProcessTiming, *utils.APIError) {
...
func ParsePdfDebug(f *io.ReadSeeker) (PdfParseDebugResponse, *utils.ProcessTiming, *utils.APIError) {
	// Initialize performance counter
	pt := utils.NewProcessTiming()
